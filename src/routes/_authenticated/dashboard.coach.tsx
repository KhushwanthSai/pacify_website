...
function reply(text: string): string {
  ...
  if (t.includes("resume"))
    return "Quick wins: lead each bullet with a verb + metric, drop the objective section, and pull 2 keywords from the JD into your skills line. ATS should jump 8-12 points.";
  if (t.includes("microsoft") || t.includes("amazon") || t.includes("google"))
    return "4 weeks DSA (trees, graphs, DP), 1 strong system-design project on GitHub, and 3 mocks. Close your system-design gap and fit moves from 40% into the 60s.";
  if (t.includes("dsa") || t.includes("leetcode"))
    return "45 min/day on patterns — sliding window, two pointers, BFS/DFS, DP on subsequences. In 6 weeks you should clear 80% of mediums.";
  if (t.includes("project"))
    return "Build one full-stack project with auth, payments, and real-time updates — that hits 4 signals at once. Avoid another to-do app.";
...
function CoachPage() {
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: "coach",
      text: "Hi Aarav — I've read your profile. Ask me anything about your readiness, target companies, or what to do this week.",
    },
  ]);
    ...
    <div className="p-6 md:p-10 max-w-4xl flex flex-col min-h-[calc(100vh-4rem)]">
      <header className="mb-6">
        ...
        <p className="text-zinc-500 mt-2">
          Tuned to your profile, your gaps, and your target companies.
        </p>
      </header>
      ...
      <p className="mt-2 text-xs text-zinc-600 italic">
        Demo mode — these replies are scripted, not generated by a model.
      </p>
    </div>
  );
}
